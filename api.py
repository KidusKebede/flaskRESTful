...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///sqliteDatabase .db'

db = SQLAlchemy(app)

# Class which represent User table
class User(db.Model):
...
#Receive token from the header and if it is valid return the user
